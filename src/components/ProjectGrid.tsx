      ...
      {projects.map((project) => (
        ...
        >
          ...
          <div className="flex flex-col gap-1 px-2 pt-1 pb-2">
            <h3 className="font-bold text-stone-800 text-lg leading-tight group-hover:text-amber-600 transition-colors line-clamp-1" title={project.name}>{project.name}</h3>
            <p className="text-sm text-stone-500 font-serif italic">{project.releaseDate || 'Lançamento a definir'}</p>
